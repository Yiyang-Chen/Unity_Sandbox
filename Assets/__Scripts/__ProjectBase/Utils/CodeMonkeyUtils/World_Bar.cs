...
namespace CodeMonkey.Utils
{
    ...
    public class World_Bar
    {
        ...
        public static World_Bar Create(Vector3 localPosition, Vector3 localScale, Color? backgroundColor,
            Color barColor, float sizeRatio, Outline outline = null)
        {
            return Create(null, localPosition, localScale, backgroundColor, barColor, sizeRatio, 0, outline);
        }

        public static World_Bar Create(Transform parent, Vector3 localPosition, Vector3 localScale,
            Color? backgroundColor, Color barColor, float sizeRatio, int sortingOrder, Outline outline = null)
        {
            return new World_Bar(parent, localPosition, localScale, backgroundColor, barColor, sizeRatio, sortingOrder,
                outline);
        }
        ...
        public void SetSortingOrder(int sortingOrder)
        {
            ...
            if (transform.Find("Outline") != null)
                transform.Find("Outline").GetComponent<SpriteRenderer>().sortingOrder = sortingOrder - 2;
        }
