...
namespace CodeMonkey.Utils
{
    ...
    public static class UtilsClass
    {
        ...
        {
            TextMesh textMesh = CreateWorldText(GetTextFunc(), parent, localPosition, fontSize, color, textAnchor,
        ...
        {
            MinimalEnvironment.Instance.GetSystem<LogSystem>().Debug(prefix + GetTimeMilliseconds(startTime));
        }
        ...
        public static void DebugDrawCircle(Vector3 center, float radius, Color color, float duration, int divisions)
        {
            ...
            {
                Vector3 vec1 = center +
                               UtilsClass.ApplyRotationToVector(new Vector3(0, 1) * radius, (360f / divisions) * i);
                Vector3 vec2 = center +
                               UtilsClass.ApplyRotationToVector(new Vector3(0, 1) * radius,
                                   (360f / divisions) * (i + 1));
        ...
        {
#if UNITY_EDITOR
            //___Singletons.Log.Debug("################# DISABLED BECAUSE OF BUILD!");
            /*
